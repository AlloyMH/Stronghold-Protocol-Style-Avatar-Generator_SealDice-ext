...
async function run(src: string) {
  try {
    ...
    if (!el) throw new Error('PreviewShell not found')
...
<template>
  <div class="bot-render-root">
    <div v-if="cropImageBase64" id="PreviewShell">
      <AvatarPreview :image-base64="cropImageBase64" />
    </div>
